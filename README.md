...
### md 저장 
- 오늘의 뉴스를 md로 저장할수 있는 화면입니다.
![상세 화면](./docs/images/createMD.png)

<br>


### 날씨
- 오늘의 날씨를 간단하게 확인할수 있는 화면입니다.
![상세 화면](./docs/images/weather.png)

<br>

### 뉴스 chat
- ai chat을 진행할수 있는 화면입니다.
- ai는 검색된 뉴스 정보를 기반으로 대답하며, 참조한 뉴스도 같이 반환합니다.
![상세 화면](./docs/images/newsChat.png)

<br>

### 뉴스 저장
- 뉴스를 저장하여 매모를 하거나 편집할수 있는 화면입니다.
![상세 화면](./docs/images/newsStorage.png)
